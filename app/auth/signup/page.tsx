            ...
            {success ? (
              <div className="bg-forest/10 border border-forest/20 px-4 py-5 text-sm text-forest">
                ...
                <p className="text-forest/80">
                  We sent a confirmation link to <strong>{form.email}</strong>. Verify your email to activate your account.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-xs text-muted">
                  ...
                  <Link href="/terms" className="text-forest underline underline-offset-2">Terms</Link> and{" "}
              ...
              <>
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center">
                    <span className="bg-beige px-3 text-xs text-muted">or continue with</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    disabled={loading}
                    className="flex items-center justify-center gap-2 border border-stone py-3 text-sm font-medium text-ink hover:border-ink hover:bg-cream transition-colors disabled:opacity-50"
                  >
